...
(global-set-key (kbd "C-,") 'completion-at-point) ;; lispy overrides this key-binding
(global-set-key (kbd "<f5>") 'completion-at-point)
...
;; Window switching
(windmove-default-keybindings) ;; Shift+direction TODO: think about it
